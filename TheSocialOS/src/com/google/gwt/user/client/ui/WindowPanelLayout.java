 ...
 * 
 */
public class WindowPanelLayout extends DecoratedPopupPanel implements HasHTML,
HasSafeHtml ,WindowDisplay{
	  ...
	  /**
	   * Check the window position into the navigation window
	   * If the window excess the limits, this method will resize the windows into a limits
	   */
	  ...
	  protected void continueResizing(int x, int y){
		    ...
		    if (resizing) {
			      ...
			      if (y >= Window.getClientHeight()){
			    	  ...
			    	  getWidget().setHeight(Window.getClientHeight() - getAbsoluteTop() - caption.getHeight() - footer.getHeight() -7 + "px");
			    	  return;
			      }
			     ...
			     //   return;
			      ...
			      if ((x-getAbsoluteLeft())<0){
			    	  return;
			      }
			      if ((y-getAbsoluteTop() - caption.getHeight() - footer.getHeight()) < 0 ){
			    	  return;
			      }
	   ...
	   * will be created when disabling text selection. Disabling should e cleared 
	...
	@Override
	public com.google.web.bindery.event.shared.HandlerRegistration addWindowEvents(
