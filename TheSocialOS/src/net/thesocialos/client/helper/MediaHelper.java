...
public class MediaHelper {
	...
	protected static void loadPictureAlbums() {
		...
		FolderWindow folder = new FolderWindow("Picture albums", FolderWindow.PICTURES,new WindowPanelLayout(false, false, new MyCaption(),new Footer()),AppConstants.IMAGEFOLDERS);
	...
	protected static void loadVideoFolders() {
		...
		FolderWindow folder = new FolderWindow("Youtube playlists", FolderWindow.VIDEOS,new WindowPanelLayout(false, false, new MyCaption(),new Footer()),AppConstants.VIDEOFOLDERS);
