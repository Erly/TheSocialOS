...
public class ChannelServer {
	...
	// private static SerializationPolicy serializationPolicy = MergedSerializationPolicy.createPushSerializationPolicy();
	  ...
	  public static void PushallUsers(List<String> userUniqueIds, Message msg){
		...
		public static void pushMessage(User user, Message msg) {
		   /* if(user.getChannelID() == null){
		    ...
		    pushMessageById(Arrays.asList(user.getEmail()), msg);
		  }
